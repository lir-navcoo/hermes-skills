---
name: "fullstack-dev"
description: "全栈后端架构与前后端集成指南，覆盖Node.js/Python/Go多语言框架、数据库访问、认证鉴权、缓存策略、实时通信和生产环境加固。当需要构建全栈应用或后端服务时使用。"
version: "1.0.0"
metadata:
  label: "全栈开发实践指南"
---
...
- [ ] Configuration **centralized**, env vars **validated at boot** (fail fast)
...
4. ✅ All config from env vars, validated at boot, fail fast
